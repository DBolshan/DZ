...
void Menu() {
    ...
    while (flag_menu != 6)
    {
        ...
        if (flag_menu == 5) {
            system("cls");
            int rele = find_hop_with_max_degree();
            cout << "Vertex with maximum degree is " << endl;
            for (int i = 0; i < 10; ++i) {
                if (TOP_HOP_MAX[i] == 1) {
                    cout << i << endl;
                }
...
int find_hop_with_max_degree() {
    ...
    if (counter1 == max) { TOP_HOP_MAX[1] = 1; }
    if (counter2 == max) { TOP_HOP_MAX[2] = 1; }
    if (counter3 == max) { TOP_HOP_MAX[3] = 1; }
    if (counter4 == max) { TOP_HOP_MAX[4] = 1; }
    if (counter5 == max) { TOP_HOP_MAX[5] = 1; }
    if (counter6 == max) { TOP_HOP_MAX[6] = 1; }
    if (counter7 == max) { TOP_HOP_MAX[7] = 1; }
    if (counter8 == max) { TOP_HOP_MAX[8] = 1; }
